...
<!-- LAYOUT DIRECTIVE:
     ...
     - Headline: 48-64px (desktop), 32-40px (mobile), bold
     - Subheadline: 20-24px (desktop), 18px (mobile), lighter weight
     - Body text: 18px, line-height 1.8
     - CTA button: Primary style, prominent, 48px height minimum
     - Vertical padding: 100-120px (desktop), 60-80px (mobile)
     - 
-->
...
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - Light background (off-white or subtle brand tint)
     - Max-width: 900px container
     - Section padding: 80-100px vertical
     - H2: 36-40px, semi-bold, with 3px accent line above (brand color)
     - Comparison block: Two-column layout (desktop) / stacked (mobile)
       * Each column: Card with light border, 24px padding
       * "Database thinking" vs "Memory thinking" side-by-side
       * Use subtle icons or checkmarks for visual interest
     - Memory types: 3-column card grid (desktop) / stacked (mobile)
       * Each card: Icon/number at top, title, description
...
<!-- Left column: Database thinking -->
<!-- Right column: Memory thinking -->
<!-- Visual: Side-by-side cards with subtle background difference -->
...
<!-- 3-COLUMN CARD GRID (or accordion on mobile) -->
<!-- Card 1: Short-Term Memory -->
<!-- Card 2: Long-Term Memory -->
<!-- Card 3: Procedural Memory -->
<!-- Each card: Number/icon at top, bold title, description, example -->
...
<!-- ============================================================ -->
<!-- SECTION 3: THE MEMORY GAP (POSITIONING SECTION)            -->
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - White background
     - Max-width: 900px
     - Section padding: 80-100px vertical
     - H2: 36-40px with accent line
     - Three-column comparison (desktop) / stacked (mobile):
       * Column 1: "What memory infrastructure gives you"
       * Column 2: "What it doesn't give you" (highlight this)
       * Column 3: "What a memory system looks like"
     - Use visual hierarchy: Column 2 should stand out (darker bg or border)
     - Bottom: 3-layer system diagram (Voice → Memory → Automation)
       * Use icons or simple illustration
...
<!-- THREE-COLUMN LAYOUT -->
<!-- Column 1: What memory infrastructure gives you -->
<!-- Column 2: What it doesn't give you (EMPHASIZED) -->
<!-- Column 3: What a memory system looks like -->
...
<!-- VISUAL: Three-layer system diagram -->
<!-- Layer 1: Voice (phone icon) -->
<!-- Layer 2: Memory (brain icon) -->
<!-- Layer 3: Automation (workflow icon) -->
<!-- Show arrows connecting them in a cycle -->
...
<!-- ============================================================ -->
<!-- SECTION 4: WHY IT MATTERS (STORY + OUTCOMES)               -->
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - Light background
     - Max-width: 900px
     - Section padding: 80-100px vertical
     - Story block: Two-column "Before/After" comparison
       * Left: "Without Memory" (red/warning tint)
       * Right: "With Memory" (green/success tint)
       * Use dialogue-style formatting (chat bubbles optional)
     - Business outcomes: 5-card grid (2-3 columns desktop / stacked mobile)
       * Each card: Number, title, description
       * Icons optional
     - Final comparison: Side-by-side bullet lists (Before vs. With Memory)
-->
...
<!-- Two-column layout: "Without Memory" vs "With Memory" -->
<!-- Use subtle background colors to differentiate -->
<!-- Dialogue format with clear speaker labels -->
...
<!-- 5-CARD GRID: Business outcomes -->
<!-- Each card: Number (large), title (bold), description -->
<!-- 2-3 columns desktop, stacked mobile -->
...
<!-- COMPARISON BLOCK: Before vs. With Memory -->
<!-- Two columns, bullet lists, clear visual differentiation -->
...
<!-- ============================================================ -->
<!-- SECTION 5: PRODUCTION-GRADE (TECHNICAL DEPTH)              -->
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - White background
     - Max-width: 900px
     - Section padding: 80-100px vertical
     - 6 failure modes: Accordion or expandable cards
       * Each: Problem → What Breaks → How We Fix It
       * Use icons for each failure mode
       * Collapsible on mobile for better UX
     - Final comparison table: Demo-grade vs. Production-grade
       * 2-column table or side-by-side cards
       * Highlight "Production-grade" column
-->
...
<!-- 6 FAILURE MODES: Accordion or expandable cards -->
<!-- Each card: Icon, title, problem, what breaks, how we fix it -->
...
<!-- COMPARISON TABLE: Demo-grade vs. Production-grade -->
<!-- Two-column layout, highlight "Production-grade" column -->
...
<!-- ============================================================ -->
<!-- SECTION 6: AI MEMORY BY ROLE (PRACTICAL EXAMPLES)          -->
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - Light background
     - Max-width: 1100px (slightly wider for cards)
     - Section padding: 80-100px vertical
     - 8 role cards: 2-3 column grid (desktop) / stacked (mobile)
       * Each card: Role icon/image, title, industry tag
       * "What it remembers" (bullet list)
       * "Critical edge cases" (italic text)
       * Example dialogue (highlighted box)
       * Business outcome (bold metrics)
...
<!-- Each card: Icon, role name, industry, what it remembers, edge cases, example, outcome -->
<!-- 2-3 columns desktop, stacked mobile -->
...
<!-- ============================================================ -->
<!-- SECTION 7: HOW WE BUILD IT (PROCESS)                        -->
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - White background
     - Max-width: 900px
     - Section padding: 80-100px vertical
     - 4-week timeline: Horizontal timeline (desktop) / vertical (mobile)
       * Each week: Number, title, 3 sub-sections (What We Do, What You Do, What You Get)
       * Use visual timeline connector (line with dots)
       * Icons for each week
     - Tech stack: 4-column grid (Voice, Memory, Automation, Retrieval)
       * Each column: Icon, category, tools listed
       * Subtle background for each column
-->
...
<!-- 4-COLUMN GRID: Tech stack categories -->
<!-- Each column: Icon, category name, tools listed -->
<!-- Voice | Memory | Automation | Retrieval -->
...
<!-- ============================================================ -->
<!-- SECTION 8: PROOF POINTS (SOCIAL PROOF)                     -->
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - Light background
     - Max-width: 1000px
     - Section padding: 80-100px vertical
     - 4 proof cards: 2-column grid (desktop) / stacked (mobile)
       * Each card: Role/industry tag, description, result metrics (large, bold)
       * Highlight PatientlyAI card (larger or featured)
     - Testimonial: Full-width quote block
       * Large quote text, attribution, photo (if available)
     - Placeholder note for team (subtle, small text)
-->
...
<!-- Card 1: PatientlyAI (featured/larger) -->
<!-- Cards 2-4: Other case studies -->
...
<!-- TESTIMONIAL BLOCK -->
<!-- Full-width quote, large text, attribution -->
...
<!-- LAYOUT DIRECTIVE:
     ...
     - Max-width: 900px
     - Section padding: 80-100px vertical
     - Accordion component: Expandable Q&A blocks
       * Question visible, click to expand answer
...
<!-- ACCORDION: 10 Q&A blocks -->
<!-- Each: Question (bold, clickable), Answer (expandable) -->
...
<!-- ============================================================ -->
<!-- LAYOUT DIRECTIVE:
     - Dark/gradient background (mirror hero section)
     - Max-width: 800px container
     - Section padding: 100-120px vertical
     - Headline: 40-48px, bold, white text
     - Body: 18-20px, lighter weight
     - CTA button: Primary style, large (56px height), prominent
     - Secondary link: Email (smaller, below CTA)
     - Visual: Optional subtle animation or gradient
-->
...
<!-- LAYOUT DIRECTIVE:
     ...
     - Use existing footer design system
