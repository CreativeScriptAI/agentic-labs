...
const Header: React.FC<Props> = ({ fullWidth }) => {
  ...
  return (
    <header className="bg-[#F9F6F4] z-50 relative">
      ...
      <div
        className={`pt-0 px-4 md:px-24 xl:px-24 md:px-4 mx-auto mx-2 md:mx-0 flex h-16 items-center justify-between translate-y-10  rounded-xl sm:bg-transparent bg-white ml-4 mr-4 sm:shadow-none shadow-[0_0_0_1px_rgba(0,0,0,0.06),0_6px_25px_0_rgba(0,0,0,0.08),0_2px_8px_0_rgba(0,0,0,0.10)]`}
      >
        {/* Logo */}
              ...
              <div className="flex flex-col pt-6 pb-6 px-6">
                ...
                <div className="w-full">
                  <div
                    ...
                    rel="noopener noreferrer"
                    className="text-center rounded-lg bg-blue-600 px-4 py-4 text-base font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 overflow-hidden"
                  >
                    Contact Us
                  </div>
                </div>
