...
import LogisticsLeadsGraphic from "src/components/sections/SgServices/LogisticsLeadsGraphic";
import { LOGISTICS_LEADS_COPY } from "src/components/sections/SgServices/logisticsLeads.copy";

const copy = LOGISTICS_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={LogisticsLeadsGraphic} />
  </>
);
