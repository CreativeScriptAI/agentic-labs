...
const UAEAboutPage = () => {
  return (
    <RootLayout>
      <NextSeo
        title={`About • ${CONFIG.blog.title} • UAE`}
        description="We combine AI tech with human intelligence and empathy to ship agents people actually trust and teams rely on in the UAE."
        openGraph={{
          title: `About • ${CONFIG.blog.title} • UAE`,
          description:
            "We combine AI tech with human intelligence and empathy to ship agents people actually trust and teams rely on in the UAE.",
          type: "website",
          url: `${CONFIG.link}/uae/about`,
        }}
      />
      <AboutHero />
      <WhyDifferent />
