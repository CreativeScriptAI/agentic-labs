...
const uuaeAgentDetailPage = ({ data }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  const agentUrl = `https://www.tryagentikai.com/uae/agent/${data?.id || ""}`;
...
export default uuaeAgentDetailPage;
