...
import B2bLeadGenGraphic from "src/components/sections/SgServices/B2bLeadGenGraphic";
import { B2B_LEAD_GEN_COPY } from "src/components/sections/SgServices/b2bLeadGen.copy";

const copy = B2B_LEAD_GEN_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={B2bLeadGenGraphic} />
  </>
);
