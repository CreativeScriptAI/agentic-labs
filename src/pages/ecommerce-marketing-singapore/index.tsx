...
import EcommerceMarketingGraphic from "src/components/sections/SgServices/EcommerceMarketingGraphic";
import { ECOMMERCE_COPY } from "src/components/sections/SgServices/ecommerceMarketing.copy";

const copy = ECOMMERCE_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={EcommerceMarketingGraphic} />
  </>
);
