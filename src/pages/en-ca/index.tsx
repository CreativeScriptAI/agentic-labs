...
import { northAmericaFaqs } from "src/data/localeFaqs";
...
const CanadaHomePage: NextPageWithLayout<HomePageProps> = ({
  agentsApiRaw,
}) => {
  const meta = {
    title: "Agentic AI Labs Canada | AI Agents, Voice & Automation Services",
    description:
      "Agentic AI Labs builds production-grade AI agents in Canada—voice, chat, and workflow automation—so founders launch reliable copilots in days.",
    type: "Website",
    url: "https://www.tryagentikai.com/canada",
    keywords: [
      "AI agents Canada",
      "automation Canada",
  ...
  return (
    <>
      ...
      <TrustedSection />
      <TestimonialsSection />
      <FAQSection faqs={northAmericaFaqs} />
      <ContactSection />
      <FooterSection />
    </>
  );
