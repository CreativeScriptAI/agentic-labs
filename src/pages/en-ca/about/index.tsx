...
const CanadaAboutPage = () => {
  return (
    <RootLayout>
      <NextSeo
        title={`About • ${CONFIG.blog.title} • Canada`}
        description="We combine AI tech with human intelligence and empathy to ship agents people actually trust and teams rely on in Canada."
        openGraph={{
          title: `About • ${CONFIG.blog.title} • Canada`,
          description:
            "We combine AI tech with human intelligence and empathy to ship agents people actually trust and teams rely on in Canada.",
          type: "website",
          url: `${CONFIG.link}/canada/about`,
        }}
      />
      <AboutHero />
      <WhyDifferent />
...
export default CanadaAboutPage;
