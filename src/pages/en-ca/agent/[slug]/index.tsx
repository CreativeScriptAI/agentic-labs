...
const CanadaAgentDetailPage = ({ data, slug }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  const agentDescription = transformedHero?.description || transformedHero?.subtitle || "Custom AI agent solution for your business needs";
  const agentImage = transformedHero?.image || "/og.jpg";
  const agentUrl = `https://www.tryagentikai.com/canada/agent/${slug}`;
...
export default CanadaAgentDetailPage;
