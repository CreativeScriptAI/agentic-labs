...
const ucanadaAgentDetailPage = ({ data }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  const agentUrl = `https://www.tryagentikai.com/canada/agent/${data?.id || ""}`;
...
export default ucanadaAgentDetailPage;
