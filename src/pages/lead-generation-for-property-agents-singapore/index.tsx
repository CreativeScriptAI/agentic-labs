...
import PropertyAgentLeadsGraphic from "src/components/sections/SgServices/PropertyAgentLeadsGraphic";
import { PROPERTY_AGENT_LEADS_COPY } from "src/components/sections/SgServices/propertyAgentLeads.copy";

const copy = PROPERTY_AGENT_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={PropertyAgentLeadsGraphic} />
  </>
);
