...
import AiReceptionistGraphic from "src/components/sections/SgServices/AiReceptionistGraphic";
import { AI_RECEPTIONIST_COPY } from "src/components/sections/SgServices/aiReceptionist.copy";

const copy = AI_RECEPTIONIST_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={AiReceptionistGraphic} />
  </>
);
