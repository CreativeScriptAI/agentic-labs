...
import FitnessLeadsGraphic from "src/components/sections/SgServices/FitnessLeadsGraphic";
import { FITNESS_LEADS_COPY } from "src/components/sections/SgServices/fitnessLeads.copy";

const copy = FITNESS_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={FitnessLeadsGraphic} />
  </>
);
