...
import DentalClinicLeadsGraphic from "src/components/sections/SgServices/DentalClinicLeadsGraphic";
import { DENTAL_CLINIC_LEADS_COPY } from "src/components/sections/SgServices/dentalClinicLeads.copy";

const copy = DENTAL_CLINIC_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={DentalClinicLeadsGraphic} />
  </>
);
