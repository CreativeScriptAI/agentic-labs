...
export const getServerSideProps = async (ctx: GetServerSidePropsContext) => {
  try {
    ...
    const staticRoutes = [
      ...
      { path: "/lead-generation-for-dental-clinics-singapore/", priority: 0.8, lastmod: "2026-08-26" },
      { path: "/lead-generation-for-property-agents-singapore/", priority: 0.8, lastmod: "2026-08-26" },
      { path: "/lead-generation-for-tuition-centres-singapore/", priority: 0.8, lastmod: "2026-08-26" },
      { path: "/lead-generation-for-logistics-singapore/", priority: 0.8, lastmod: "2026-08-26" },
      { path: "/lead-generation-for-fitness-studios-singapore/", priority: 0.8, lastmod: "2026-08-26" },
      { path: "/high-converting-landing-pages-singapore/", priority: 0.85, lastmod: "2026-08-26" },
      { path: "/affordable-web-design-singapore/", priority: 0.85, lastmod: "2026-08-26" },
      { path: "/ecommerce-marketing-singapore/", priority: 0.85, lastmod: "2026-08-26" },
      { path: "/glossary/", priority: 0.7, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-aeo/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/aeo-vs-geo-vs-seo/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-speed-to-lead/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-lead-qualification/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/mql-vs-sql/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-a-product-qualified-lead/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-bant/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/lead-qualification-vs-lead-scoring/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-pdpa/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-the-psg-grant/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/how-to-rank-in-chatgpt/", priority: 0.65, lastmod: "2026-09-02" },
      { path: "/glossary/how-to-get-cited-by-perplexity/", priority: 0.65, lastmod: "2026-09-02" },
      { path: "/glossary/does-llms-txt-help/", priority: 0.6, lastmod: "2026-09-02" },
      { path: "/glossary/what-is-geo/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-rag/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-lead-scoring/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-conversational-ai/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-whatsapp-business-api/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-the-do-not-call-registry/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-click-through-rate/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-cost-per-lead/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-customer-acquisition-cost/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-marketing-automation/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-a-drip-campaign/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-no-show-rate/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-appointment-setting/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-a-sales-development-representative/", priority: 0.6, lastmod: "2026-09-03" },
      { path: "/glossary/what-is-return-on-ad-spend/", priority: 0.6, lastmod: "2026-09-03" },
