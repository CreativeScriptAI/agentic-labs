...
const UKAboutPage = () => {
  return (
    <RootLayout>
      <NextSeo
        title={`About • ${CONFIG.blog.title} • UK`}
        description="We combine AI tech with human intelligence and empathy to ship agents people actually trust and teams rely on in the UK."
        openGraph={{
          title: `About • ${CONFIG.blog.title} • UK`,
          description:
            "We combine AI tech with human intelligence and empathy to ship agents people actually trust and teams rely on in the UK.",
          type: "website",
          url: `${CONFIG.link}/uk/about`,
        }}
      />
      <AboutHero />
      <WhyDifferent />
