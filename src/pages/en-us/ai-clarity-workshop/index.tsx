...
export default function USAAiClarityPage() {
  return (
    <>
      <section className="min-h-screen bg-background [&_*]:box-border">
        <NextSeo
          title="AI Clarity Workshop USA | American Founders"
          description="Learn how to use AI to improve your business in the USA. Free 30-minute clarity session for American founders."
          openGraph={{
            title: "AI Clarity Workshop USA | American Founders",
            description:
              "Learn how to use AI to improve your business in the USA. Free 30-minute clarity session for American founders.",
            type: "website",
            url: "https://www.tryagentikai.com/en-us/ai-clarity-workshop",
            images: [
              {
                url: "https://www.tryagentikai.com/og.jpg",
                width: 1200,
                height: 630,
                alt: "AI Clarity Workshop USA",
              },
            ],
          }}
        />
