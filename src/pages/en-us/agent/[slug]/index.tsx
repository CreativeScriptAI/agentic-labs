...
const uusaAgentDetailPage = ({ data }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  const agentUrl = `https://www.tryagentikai.com/usa/agent/${data?.id || ""}`;
...
export default uusaAgentDetailPage;
