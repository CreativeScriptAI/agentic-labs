...
import ContentGraphic from "src/components/sections/SgServices/ContentGraphic";
import { CONTENT_COPY } from "src/components/sections/SgServices/content.copy";
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={ContentGraphic} />
  </>
);
