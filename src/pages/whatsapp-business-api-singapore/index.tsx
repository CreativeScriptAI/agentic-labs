...
import WhatsappApiGraphic from "src/components/sections/SgServices/WhatsappApiGraphic";
import { WHATSAPP_API_COPY } from "src/components/sections/SgServices/whatsappApi.copy";

const copy = WHATSAPP_API_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={WhatsappApiGraphic} />
  </>
);
