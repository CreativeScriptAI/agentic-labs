...
import WebDesignGraphic from "src/components/sections/SgServices/WebDesignGraphic";
import { WEB_DESIGN_COPY } from "src/components/sections/SgServices/webDesign.copy";

const copy = WEB_DESIGN_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={WebDesignGraphic} />
  </>
);
