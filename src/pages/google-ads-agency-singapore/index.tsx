...
import GoogleAdsGraphic from "src/components/sections/SgServices/GoogleAdsGraphic";
import { GOOGLE_ADS_COPY } from "src/components/sections/SgServices/googleAds.copy";

const copy = GOOGLE_ADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={GoogleAdsGraphic} />
  </>
);
