...
const SectionLabel = ({ text, dark = false }: { text: string; dark?: boolean }) => (
  <p
    className={`font-geist font-normal text-[12px] tracking-[0.02em] uppercase mb-3 flex items-center gap-2 ${
...
const PrimaryBtn = ({
  ...
  const cls = `inline-flex items-center justify-center whitespace-nowrap rounded-none bg-[#FCCA07] text-[#0A1128] font-alte font-normal transition-all hover:bg-[#f0bd00] active:scale-[0.98] cursor-pointer ${sizeMap[size]} ${fullWidth ? "w-full" : ""}`;
...
const OutlineBtn = ({
  ...
  const cls = `inline-flex items-center justify-center rounded-none border font-alte font-normal transition-all active:scale-[0.98] cursor-pointer ${
    dark
    ...
    <Container size="lg" className="relative">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[3.6rem] font-alte font-normal text-white leading-[1.08] tracking-[-0.04em] mb-6">
            <span className="text-[#FCCA07]">7 leads</span> called<br />
            last night.<br />
            <span className="text-white/65">All 7 got answered.</span>
          </h1>

          <p className="text-lg sm:text-xl text-white/80 max-w-lg mb-3 leading-relaxed font-alte font-normal">
            Loop answers every call and follows up on text, automatically, in any language, 24/7.
          </p>
          <p className="text-base text-white/50 mb-4 max-w-md leading-relaxed font-alte font-normal">
            Like a full-time receptionist, except it costs{" "}
            <span className="text-white/75 font-normal">$49/month</span> and never misses a call.
          </p>

          <div className="flex items-center gap-2 mb-10">
            <span className="inline-flex items-center gap-1.5 text-xs font-normal tracking-wide text-[#25D366] bg-[#25D366]/10 border border-[#25D366]/25 rounded-full px-3 py-1.5 font-alte">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-10">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap px-7 py-3.5 rounded-none text-white text-sm font-alte font-normal transition-all hover:bg-white/10 active:scale-[0.98]" style={{ border: "1px solid rgba(255,255,255,0.55)" }}
            >
              Plans from $49/mo
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-white/40 font-alte font-normal">
        ...
        <div className="relative hidden lg:block h-[600px]" style={{ perspective: "1000px" }}>
          ...
          <div className="absolute" style={{ top: "10%", right: "20%", transform: "rotate(8deg)", zIndex: 3 }}>
            <div className="bg-white w-[260px] h-[360px] p-4 flex flex-col border border-[#e7e6e4]">
              <div className="flex justify-between text-[12px] font-geist font-normal uppercase tracking-[0.02em] border-b border-gray-100 pb-2 mb-3 text-gray-500">
              ...
              <div className="mt-auto border-t border-gray-100 pt-3 flex justify-between items-end">
                <div>
                  ...
                  <div className="text-[9px] text-gray-400 mt-0.5 tracking-wide font-alte font-normal">+4 appointments today</div>
                </div>
                <button
                  onClick={() => { onCardPlay("dental"); document.getElementById("hear-it")?.scrollIntoView({ behavior: "smooth", block: "start" }); }}
                  style={{ width: 28, height: 28, borderRadius: "50%", background: "#FF5500", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}
            ...
            <div className="bg-white w-[260px] h-[360px] p-4 flex flex-col border border-[#e7e6e4]">
              ...
              <div className="mt-auto border-t border-gray-100 pt-3 flex justify-between items-end">
                <div>
                  ...
                  <div className="text-[9px] text-gray-400 mt-0.5 tracking-wide font-alte font-normal">12 candidates screened</div>
                </div>
                <button
                  onClick={() => { onCardPlay("hiring"); document.getElementById("hear-it")?.scrollIntoView({ behavior: "smooth", block: "start" }); }}
                  style={{ width: 28, height: 28, borderRadius: "50%", background: "#FF0055", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}
                  title="Hear this agent"
                >
                  <svg width="10" height="12" viewBox="0 0 10 12" fill="white"><path d="M0 0L10 6L0 12V0Z"/></svg>
                </button>
            ...
            <div className="bg-white w-[260px] h-[360px] p-4 flex flex-col border border-[#e7e6e4]">
              ...
              <div className="mt-auto border-t border-gray-100 pt-3 flex justify-between items-end">
                <div>
                  ...
                  <div className="text-[9px] text-gray-400 mt-0.5 tracking-wide font-alte font-normal">3 viewings booked</div>
                </div>
                <button
                  onClick={() => { onCardPlay("realestate"); document.getElementById("hear-it")?.scrollIntoView({ behavior: "smooth", block: "start" }); }}
                  style={{ width: 28, height: 28, borderRadius: "50%", background: "#3300FF", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}
                  title="Hear this agent"
                >
                  <svg width="10" height="12" viewBox="0 0 10 12" fill="white"><path d="M0 0L10 6L0 12V0Z"/></svg>
                </button>
  ...
  <div className="bg-slate-50 rounded-none border-4 border-[#1e293b] overflow-hidden relative h-full flex flex-col font-alte font-normal transition-all">
    <div className="bg-white px-6 py-5 flex items-center justify-between border-b border-slate-200 relative z-10">
      <div className="flex items-center gap-3">
        ...
        <h5 className="text-slate-800 text-xs font-normal tracking-widest uppercase font-alte">Lead CRM</h5>
      </div>
      <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-none bg-emerald-50 border border-emerald-100">
        ...
        <span className="text-[12px] font-geist font-normal uppercase tracking-[0.02em] text-emerald-700">Live Sync</span>
      </div>
    </div>
        ...
        {[
          ...
          <div key={i} className="flex items-center justify-between p-4 rounded-none bg-white border border-slate-200 opacity-50 relative ml-8">
            ...
            <div className="flex items-center gap-3.5">
              <div className={`w-9 h-9 rounded-full flex items-center justify-center text-xs font-normal font-alte border ${lead.color}`}>{lead.name[0]}</div>
              <div>
                <p className="text-sm text-slate-700 font-normal font-alte">{lead.name}</p>
                <p className="text-[10px] text-slate-400 font-normal font-alte">{lead.time}</p>
              </div>
            </div>
          </div>
        ))}
          ...
          {isVisible && (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-100">
                <div className="flex items-center gap-3.5">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#2D22FF] to-[#1e17ba] flex items-center justify-center text-sm font-normal font-alte text-white">{leadName[0]}</div>
                  <div className="min-w-0">
                    <p className="text-sm font-normal font-alte text-slate-800 truncate">{leadName}</p>
                    <p className="text-[10px] text-slate-500 font-normal font-alte">Synced via Voice</p>
                  </div>
                </div>
                <span className="px-2.5 py-1 rounded-none text-[9px] font-normal font-alte bg-emerald-50 text-emerald-600 border border-emerald-100 leading-none">Appointment Booked</span>
              </div>
              <div className="space-y-3">
                <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="text-[12px] text-slate-400 font-geist font-normal tracking-[0.02em] uppercase">Summary</span>
                    <span className="text-[9px] text-[#2D22FF] font-normal font-alte bg-[#2D22FF]/5 px-2 py-0.5 rounded-none flex items-center gap-1">
                  ...
                  <div className="bg-slate-50 rounded-none p-3 border border-slate-100">
                    <p className="text-xs text-slate-600 leading-relaxed font-alte font-normal">&quot;{data.notes}&quot;</p>
                  </div>
                </div>
              </div>
            </motion.div>
    ...
    <div className="py-4 bg-white border-t border-slate-100 flex items-center justify-center gap-1.5 opacity-40 grayscale">
      <span className="text-[12px] font-geist font-normal uppercase tracking-[0.02em]">Powered by Loop AI</span>
    </div>
  </div>
);
  ...
  <div className="h-full flex flex-col font-alte font-normal bg-[#e5ddd5]" style={{ backgroundImage: "url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')", backgroundSize: "450px" }}>
    <div className="bg-[#075e54] pt-10 pb-3 px-3 flex items-center z-20 sticky top-0">
      <div className="flex items-center gap-1 text-white mr-1">
        ...
        <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center font-alte font-normal text-sm">R</div>
      </div>
      <div className="flex-1 min-w-0">
        <h5 className="text-white text-[16px] font-normal font-alte leading-tight truncate">Loop AI</h5>
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="bg-white p-2.5 rounded-none max-w-[85%] relative self-start mt-2"
          >
            ...
            <div className="absolute bottom-1 right-1.5 flex items-center gap-0.5 opacity-50">
              <span className="text-[9px] text-[#667781] font-normal leading-none">16:42</span>
    ...
    <div className="p-2 pb-6 flex gap-2 items-center bg-transparent z-10">
      <div className="bg-white rounded-full flex-1 h-[42px] px-3 flex items-center gap-3 border border-[#e7e6e4]">
      ...
      <div className="w-[42px] h-[42px] rounded-full bg-[#00a884] flex items-center justify-center text-white active:scale-95 transition-transform">
    ...
    <section ref={sectionRef} id="hear-it" className="py-24 sm:py-32 bg-[#050B1B] relative overflow-hidden">
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-7xl font-alte font-normal text-white leading-[1.2] tracking-[-0.04em] mb-6">Experience the <span className="text-white/80">End-to-End</span> Loop.</h2>
          <p className="text-white/60 text-lg max-w-2xl mx-auto font-alte font-normal">Watch how Vox answers the call, triggers Relay for follow-up, and logs everything to your CRM in real-time.</p>
        </div>

        <div className="flex justify-center gap-3 mb-16">
          {(Object.keys(DEMOS) as DemoTab[]).map((tab) => (
            <button key={tab} onClick={() => onTabChange(tab)}
              className={`px-6 py-2.5 rounded-none text-xs font-alte font-normal transition-all duration-300 border ${activeTab === tab ? "bg-[#2D22FF] border-[#2D22FF] text-white" : "border-white/10 text-white/40 hover:text-white"}`}>
              {DEMOS[tab].label}
            </button>
          ))}
        </div>
        ...
        <div className="max-w-[1400px] mx-auto relative mt-8">
          <div className="flex flex-col xl:flex-row items-stretch gap-10 xl:gap-6">
            ...
            <div className={`flex-[1.4] transition-all duration-700 ${currentStep < 1 ? "opacity-20 blur-[2px]" : "opacity-100"}`}>
              <div className="mb-4 flex items-center gap-2 px-2 text-[12px] font-geist font-normal tracking-[0.02em] text-white/30 uppercase">
                <div className={`w-2 h-2 rounded-full ${currentStep === 1 ? 'bg-[#2D22FF] animate-pulse' : 'bg-white/10'}`} /> 01. Voice Agent (Vox)
              </div>
              <div className="rounded-none border-4 border-[#1e293b] overflow-hidden relative h-[600px] flex flex-col transition-all duration-500 bg-[#0A0D14]">
                <div className="px-6 pt-12 pb-5 border-b border-white/5 flex items-center justify-between bg-black/40 backdrop-blur-xl z-20">
                  <div className="flex items-center gap-4 min-w-0 flex-1">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 transition-all ${currentStep >= 1 ? "bg-[#2D22FF]" : "bg-white/5"}`}>
                    ...
                    <div className="flex flex-col min-w-0">
                      <div className="text-white text-[15px] font-normal font-alte flex items-center gap-1.5 leading-tight truncate">
                        {demo.callerName} <span className="text-white/20 font-normal">to</span> <span className="text-[#818cf8] shrink-0">Vox AI</span>
                      </div>
                      <p className="text-white/30 text-[12px] font-geist font-normal mt-1 uppercase tracking-[0.02em] truncate">{demo.scenario}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <AnimatePresence mode="wait">
                    {currentStep === 0 ? (
                      <motion.div key="p" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="h-full flex flex-col items-center justify-center p-8 text-center">
                        <button onClick={handlePlay} className="w-20 h-20 rounded-full bg-[#2D22FF] flex items-center justify-center mb-6 transition-transform hover:scale-110 active:scale-95"><svg width="36" height="36" viewBox="0 0 24 24" fill="white" className="ml-1.5"><path d="M5 3l14 9-14 9V3z"/></svg></button>
                        <p className="text-white/20 text-[12px] font-geist font-normal tracking-[0.02em] uppercase">Simulate Real Interaction</p>
                      </motion.div>
                    ) : (
                      <motion.div key="t" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="h-full px-5 py-8 overflow-y-auto scrollbar-hide flex flex-col gap-6 pb-20" ref={transcriptRef}>
                        {demo.transcript.slice(0, visibleMessages).map((msg, i) => (
                          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} key={i} className={`flex gap-3 max-w-[85%] ${msg.speaker === "Vox" ? "flex-row mr-auto" : "flex-row-reverse ml-auto"}`}>
                            <div className={`w-7 h-7 rounded-full shrink-0 flex items-center justify-center text-[10px] font-normal font-alte mt-auto mb-1 ${msg.speaker === "Vox" ? "bg-[#1e293b] text-white" : "bg-white/10 text-white/60"}`}>{msg.speaker === "Vox" ? "V" : demo.callerName[0]}</div>
                            <div className={`px-4 py-3 rounded-none text-[13.5px] leading-relaxed font-alte font-normal ${msg.speaker === "Vox" ? "bg-[#1e293b]/80 border border-white/5 text-white/90" : "bg-[#2D22FF] text-white"}`}><p>{msg.text}</p></div>
                          </motion.div>
                        ))}
                      </motion.div>
                    )}
                ...
                <div className="p-6 bg-black/40 backdrop-blur-xl border-t border-white/5 flex flex-col gap-4 sticky bottom-0 z-20">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2"><div className={`w-2 h-2 rounded-full ${isPlaying ? 'bg-emerald-400 animate-ping' : 'bg-white/10'}`} /><span className="text-[12px] text-white/30 font-geist font-normal uppercase tracking-[0.02em]">{isPlaying ? 'Processing Voice' : 'Ready'}</span></div>
                    {currentStep > 0 && <button onClick={handlePlay} className="text-[12px] text-[#2D22FF] font-geist font-normal uppercase tracking-[0.02em]">Restart</button>}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`flex-[1.1] transition-all duration-700 ${currentStep < 2 ? "opacity-10 blur-[3px] scale-95" : "opacity-100 scale-100"}`}>
              ...
              <div className="h-[600px] rounded-none border-4 border-[#1e293b] overflow-hidden">
          ...
          {metrics.map((m, i) => (
            <div key={i} className="flex flex-col items-center justify-center text-center group">
              ...
              <div className="flex items-baseline justify-center gap-[2px]">
                {m.prefix && <span className="font-geist font-normal text-sm text-[#0A1128]/30 mr-0.5" style={{ fontFeatureSettings: '"tnum"' }}>{m.prefix}</span>}
                <span className="font-alte font-normal text-[2.75rem] sm:text-[3rem] text-[#0A1128] leading-none tracking-[-0.04em]">{m.num}</span>
                {m.unit && <span className="font-geist font-normal text-xs text-[#0A1128]/30 ml-0.5 uppercase tracking-[0.02em]">{m.unit}</span>}
              </div>
              <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-[#0A1128]/30 mt-3">{m.label}</p>
            </div>
          ))}
        </div>
      </Container>
      ...
      <Container size="lg">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="text-4xl sm:text-5xl font-alte font-normal text-[#0A1128] leading-[1.2] tracking-[-0.04em] mb-6">
              Your marketing is working.<br />
              <span className="text-gray-400">Missed calls aren&apos;t.</span>
            </h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed font-alte font-normal">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-5 rounded-none bg-[#0A1128]/[0.02] border border-[#e7e6e4]">
                ...
                <div>
                  <p className="font-normal font-alte text-[#0A1128] text-sm mb-1">The 3-Second Rule</p>
                  <p className="text-sm text-gray-500 leading-relaxed font-alte font-normal">If you don&apos;t answer, a lead takes 3 seconds to open Google Maps and call your next competitor. You never get a second chance.</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-none border border-[#e7e6e4] relative overflow-hidden flex flex-col">
              <div className="px-7 py-5 bg-[#0A1128] flex justify-between items-center z-10">
                <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-white/50">Ledger of Uncaptured Revenue</p>
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.03] border border-white/5">
                  ...
                  <p className="text-[12px] font-geist font-normal text-rose-300/80 tracking-[0.02em] uppercase">Active Leakage</p>
                </div>
              </div>
              <div className="divide-y divide-gray-100/80 bg-white">
                {costs.map((c, i) => (
                  <div key={i} className="group px-7 py-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all hover:bg-gray-50/50">
                    <div className="flex-1 min-w-0">
                      <p className="text-[12px] font-geist font-normal text-gray-400 uppercase tracking-[0.02em] mb-1.5">{c.scenario}</p>
                      <p className="text-sm text-[#0A1128] font-normal font-alte max-w-xs">{c.note}</p>
                    </div>
                    <div className="flex flex-col items-end">
                      ...
                      <span className="text-[12px] font-geist font-normal text-gray-300 uppercase tracking-[0.02em]">{c.impact}</span>
                    </div>
                  </div>
                ))}
              </div>
              <div className="bg-[#050A14] p-8 text-white relative border-t border-gray-100 flex-1">
                ...
                <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-white/40 mb-6 flex items-center gap-3">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 group">
                      <div className="w-7 h-7 rounded-none bg-white/[0.02] border border-white/5 flex items-center justify-center flex-shrink-0 text-white/30 text-[10px] font-geist font-normal group-hover:bg-white/5 transition-colors">0{i+1}</div>
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-normal font-alte text-white/80 truncate mb-0.5">{row.t}</p>
                        <p className="text-[11px] text-white/30 font-alte font-normal">{row.s}</p>
                      </div>
                      <div className="text-[9px] font-normal font-alte px-2.5 py-1 rounded-none bg-white/[0.03] text-white/40 border border-white/5 whitespace-nowrap">{row.tag}</div>
                    </div>
                  ))}
                </div>
                <div className="mt-8 pt-6 border-t border-white/5">
                  <p className="font-alte font-normal text-[1.35rem] text-white/90 leading-snug">
                    ...
                    <span className="text-white/30">It just slipped through the cracks.</span>
                  </p>
                </div>
              </div>
            </div>
    ...
    <Container size="lg">
      <div className="flex flex-col gap-3 mb-12">
        {["Hire a second receptionist. She gets busy too.", "Add a chatbot. Half your leads call instead of typing.", "Buy a generic voice bot. Lead goes cold. Nobody follows up."].map((t, i) => (
          <div key={i} className="flex items-center gap-3 text-sm text-gray-400 group font-alte font-normal">
        ...
        <p className="text-lg font-normal font-alte text-[#0A1128] mt-4 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-end mb-16">
        <div>
          ...
          <h2 className="text-4xl sm:text-5xl font-alte font-normal text-[#0A1128] leading-[1.2] tracking-[-0.04em] mb-4">
            Every call answered.<br />
            Every lead followed up.<br />
            <span className="text-gray-400">You only get pinged when it&apos;s hot.</span>
          </h2>
        </div>
        <p className="text-lg text-gray-500 max-w-md leading-relaxed mb-1 font-alte font-normal">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative">
        ...
        <div className="group bg-white rounded-none p-8 sm:p-10 border border-orange-100 transition-all hover:-translate-y-1">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <span className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-orange-500 bg-orange-50 px-2 py-0.5 rounded-none">The Voice</span>
              <p className="text-2xl font-normal font-alte text-[#0A1128]">Vox</p>
            </div>
          </div>
          <ul className="space-y-5">
            {[
              ...
              <li key={i} className="flex gap-4">
                ...
                <div>
                  <p className="text-sm font-normal font-alte text-[#0A1128] mb-0.5">{f.t}</p>
                  <p className="text-xs text-gray-500 leading-relaxed font-alte font-normal">{f.s}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <div className="group bg-white rounded-none p-8 sm:p-10 border border-green-100 transition-all hover:-translate-y-1">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <span className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-green-600 bg-green-50 px-2 py-0.5 rounded-none">The Follow-Up</span>
              <p className="text-2xl font-normal font-alte text-[#0A1128]">Relay</p>
            </div>
          </div>
          <ul className="space-y-5">
            {[
      ...
      <div className="flex flex-col items-center mt-12 mb-20">
        ...
        <div className="bg-[#0A1128] text-white px-8 py-4 rounded-none flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-normal font-alte leading-tight">You only get pinged when a lead is HOT.</p>
            <p className="text-[12px] text-white/40 font-geist font-normal uppercase tracking-[0.02em] mt-0.5">Direct SMS or text alert to your phone</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-none p-8 sm:p-12 border border-[#e7e6e4] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative">
          <div className="lg:col-span-4">
            <div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-[12px] font-geist font-normal tracking-[0.02em] uppercase">Continuous Improvement</div>
            <h3 className="text-3xl font-alte font-normal text-[#0A1128] mb-4">Gets sharper with every call.</h3>
            <p className="text-sm text-gray-500 leading-relaxed font-alte font-normal">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="p-6 rounded-none bg-gray-50 border border-[#e7e6e4] group transition-all hover:bg-[#0A1128] hover:text-white">
                ...
                <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 group-hover:text-white/40 mb-2">{m.w}</p>
                <p className="font-normal font-alte text-sm mb-2 text-[#0A1128] group-hover:text-white">{m.h}</p>
                <p className="text-xs text-gray-500 group-hover:text-white/60 leading-relaxed font-alte font-normal">{m.s}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <section className="py-24 sm:py-32 bg-[#F9F6F4] overflow-hidden relative">
      ...
      <Container size="lg">
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-4xl sm:text-6xl font-alte font-normal text-[#0A1128] leading-[1.2] tracking-[-0.04em] mb-4">
            Three steps.<br /><span className="text-gray-400">You barely have to show up.</span>
          </h2>
          <p className="text-lg text-gray-500 max-w-xl mx-auto leading-relaxed font-alte font-normal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, i) => (
            <div key={i} className="group relative bg-white/50 border border-[#e7e6e4] rounded-none p-8 transition-all hover:bg-white hover:-translate-y-1">
              <div className="flex items-center justify-between mb-8">
                <div className="w-12 h-12 rounded-none bg-[#0A1128] text-[#FCCA07] flex items-center justify-center font-normal font-alte text-xl">{step.num}</div>
                <div className="px-3 py-1 rounded-full bg-[#0A1128]/5 border border-[#0A1128]/5 text-[#0A1128] text-[12px] font-geist font-normal tracking-[0.02em] uppercase">{step.badge}</div>
              </div>
              <div className="mb-6">
                <div className="w-10 h-10 rounded-full bg-white border border-[#e7e6e4] flex items-center justify-center text-[#0A1128] mb-4 group-hover:scale-110 transition-transform">{step.icon}</div>
                <h3 className="text-2xl font-alte font-normal text-[#0A1128] mb-3">{step.title}</h3>
                <p className="text-sm text-gray-500 leading-relaxed min-h-[48px] font-alte font-normal">{step.sub}</p>
              </div>
              <ul className="space-y-3 mb-8">
                {step.bullets.map((b, j) => (
                  <li key={j} className="flex gap-2 text-xs text-gray-600 leading-relaxed font-alte font-normal">
                    <span className="text-gray-400 flex-shrink-0 mt-0.5">-</span>{b}
                  </li>
                ))}
              </ul>
              <p className="text-[11px] font-normal font-alte text-[#0A1128] border-t border-[#e7e6e4] pt-3">{step.you}</p>
              {i < steps.length - 1 && (
  ...
  return (
    <section id="use-cases" className="py-20 sm:py-24 bg-[#F9F6F4]">
      <Container>
        ...
        <h2 className="text-3xl sm:text-4xl font-alte font-normal text-[#0A1128] leading-[1.2] tracking-[-0.04em] mb-8">
        ...
        <div className="flex gap-0 mb-10 border-b border-gray-200 overflow-x-auto">
          {tabs.map((t) => (
            <button key={t.key} onClick={() => setActive(t.key)}
              className={`flex items-center gap-2 px-5 py-3 text-sm font-alte font-normal whitespace-nowrap transition-all border-b-2 -mb-px ${active === t.key ? "border-[#0A1128] text-[#0A1128]" : "border-transparent text-gray-400 hover:text-gray-600"}`}>
        ...
        <div className="bg-white border border-[#e7e6e4] overflow-hidden rounded-none">
          <div style={{ borderTop: `3px solid ${uc.accentColor}` }}>
            <div className="bg-[#0A1128] px-6 sm:px-8 py-6">
              <span className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase flex items-center gap-2" style={{ color: uc.accentColor }}>
                <span className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: uc.accentColor }} />{uc.role}
              </span>
              <h3 className="text-xl sm:text-2xl font-alte font-normal text-white mt-2 leading-snug">{uc.headline}</h3>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-5 border-b border-gray-100">
            <div className="sm:col-span-2 px-6 sm:px-8 py-6 bg-gray-50 border-b border-gray-100 sm:border-b-0 sm:border-r sm:border-gray-100">
              <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 mb-4">The problem</p>
              <div className="flex gap-2 mb-5">
                {uc.snap.map((s, i) => (
                  <div key={i} className="flex-1 bg-white rounded-none border border-[#e7e6e4] p-3 text-center">
                    ...
                    <p className="text-[10px] text-gray-400 mt-1.5 leading-tight font-alte font-normal">{s.label}</p>
                  </div>
                ))}
              </div>
            ...
            <div className="sm:col-span-3 px-6 sm:px-8 py-6">
              <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 mb-4">With Loop</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {uc.outcomes.map((o, i) => (
                  <div key={i} className="flex items-center gap-2.5 rounded-none border border-[#e7e6e4] bg-white px-3 py-2.5">
                    <span className="flex-shrink-0" style={{ color: uc.accentColor }}>{OUTCOME_ICONS[o.icon]}</span>
                    <span className="text-[13px] text-[#0A1128] font-normal font-alte leading-snug">{o.text}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="px-6 sm:px-8 py-6 border-b border-gray-100">
            <div className="grid grid-cols-[1fr_1fr_1fr] gap-x-3 gap-y-2">
              <div className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 pb-1" />
              <div className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 pb-1">Before</div>
              <div className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase pb-1" style={{ color: uc.accentColor }}>With Loop</div>
              {uc.comparison.map((row, i) => (
                <>
                  <div key={`m${i}`} className="text-xs text-gray-500 self-center py-1 font-alte font-normal">{row.metric}</div>
                  <div key={`b${i}`} className="bg-gray-100 rounded-none px-3 py-2 text-xs font-normal font-alte text-gray-600">{row.before}</div>
                  <div key={`a${i}`} className="rounded-none px-3 py-2 text-xs font-normal font-alte" style={{ background: "#F0FDF4", color: "#15803d" }}>{row.after}</div>
                </>
              ))}
            </div>
          </div>
          <div className="px-6 sm:px-8 py-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <p className="text-sm font-normal font-alte text-[#0A1128]">{uc.cta.label}</p>
                <p className="text-xs text-gray-500 mt-0.5 font-alte font-normal">{uc.cta.note}</p>
              </div>
  ...
  return (
    <Container className="mt-16">
      <div className="mb-10">
        ...
        <p className="text-sm text-gray-500 max-w-lg font-alte font-normal">Same Loop, configured for how your business actually works.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        {cases.map((c, i) => (
          <div key={i} className="group relative bg-white rounded-none p-6 border border-[#e7e6e4] flex flex-col gap-4 transition-all hover:-translate-y-1" style={{ borderTop: `2px solid ${c.accent}` }}>
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase mb-0.5" style={{ color: c.accent }}>{c.role}</p>
                <p className="font-normal font-alte text-[#0A1128] text-sm truncate">{c.industry}</p>
              </div>
            </div>
            <p className="text-xs text-gray-500 leading-relaxed font-alte font-normal">{c.outcome}</p>
            <div className="mt-auto pt-4 border-t border-[#e7e6e4] flex items-center justify-between">
              <span className={`inline-flex px-2 py-1 rounded-none text-[9px] font-normal font-alte tracking-tight ${i % 2 === 0 ? "bg-blue-50 text-blue-600" : "bg-orange-50 text-orange-600"}`}>{c.metric}</span>
      ...
      <div className="bg-[#0A1128] rounded-none px-7 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 overflow-hidden relative">
        ...
        <div className="relative">
          <p className="text-white font-normal font-alte text-base mb-1">Don&apos;t see your industry?</p>
          <p className="text-white/50 text-xs max-w-md leading-relaxed font-alte font-normal">We&apos;ve built for 20+ use cases. If you have calls, leads, or candidates, Loop works. We build your exact script in 30 minutes.</p>
        </div>
        <div className="relative"><BracketButton label="Check your use case" href={CAL_LINK} variant="primary" external /></div>
      </div>
    </Container>
  );
};
      ...
      <Container size="lg">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            ...
            <p className="text-lg text-gray-500 mb-8 leading-relaxed font-alte font-normal">
            ...
            <div className="p-6 rounded-none bg-[#0A1128] text-white">
              <p className="text-sm font-geist font-normal text-[#FCCA07] uppercase tracking-[0.02em] mb-2">The Loop Promise</p>
              <p className="text-xs text-white/60 leading-relaxed mb-4 font-alte font-normal">
              ...
              <div className="flex items-center gap-2 text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-white/30">
          ...
          <div className="lg:col-span-7 space-y-4">
            {points.map((p, i) => (
              <div key={i} className="group relative p-8 bg-gray-50 rounded-none border border-[#e7e6e4] transition-all hover:bg-white hover:border-[#FCCA07]/30">
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="flex-shrink-0 w-12 h-12 rounded-none bg-white border border-[#e7e6e4] flex items-center justify-center text-2xl transition-transform group-hover:scale-110">{p.icon}</div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xl font-normal font-alte text-[#0A1128] mb-2">{p.title}</h3>
                    <p className="text-sm text-gray-500 leading-relaxed font-alte font-normal">{p.sub}</p>
                  </div>
            ...
            <div className="mt-12 p-8 rounded-none border border-dashed border-gray-200 opacity-50 bg-gray-50/50">
              <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 mb-6">Traditional Alternatives</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <p className="text-xs font-normal font-alte text-gray-400 mb-1 line-through">Generic Voice Platforms</p>
                  <p className="text-[12px] font-geist font-normal text-gray-400 uppercase tracking-[0.02em]">Requires Dev Team · Robotic outputs · Higher cost</p>
                </div>
                <div>
                  <p className="text-xs font-normal font-alte text-gray-400 mb-1 line-through">Text Chatbots</p>
                  <p className="text-[12px] font-geist font-normal text-gray-400 uppercase tracking-[0.02em]">Lower conversion · Lead friction · Manual entry</p>
                </div>
              </div>
            </div>
          </div>
...
const PricingCalculator = () => {
  ...
  const DurationBtn = ({ val }: { val: number }) => (
    <button onClick={() => setAvgDuration(val)}
      className={`px-5 py-2 rounded-none text-sm font-alte font-normal border transition-all ${
        avgDuration === val
  ...
  return (
    <div className="rounded-none overflow-hidden border border-[#e7e6e4] mb-12 bg-white">
      ...
      <div className="px-8 py-5 border-b border-gray-100">
        <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-[#2D22FF] mb-0.5">Pricing Calculator</p>
        <p className="text-base font-normal font-alte text-[#0A1128]">
      ...
      <div className="px-8 py-7 border-b border-gray-100 grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-8 items-start">
        <div>
          <div className="flex items-end justify-between mb-3">
            <div>
              <p className="text-sm font-normal font-alte text-[#0A1128]">How many calls do you get per day?</p>
              <p className="text-xs text-gray-400 mt-0.5 font-alte font-normal">Include missed calls, after-hours, voicemail rings</p>
            </div>
            <div className="ml-4 flex-shrink-0 text-right">
              <span className="text-3xl font-alte font-normal text-[#0A1128] leading-none">{callsPerDay}</span>
              <span className="text-sm font-normal text-gray-400 ml-1 font-alte">/day</span>
              <p className="text-[11px] text-gray-400 mt-0.5 font-alte font-normal">{callsPerMonth} calls/mo · {minutesNeeded} min/mo</p>
            </div>
          </div>
          ...
          <div className="flex justify-between mt-2">
            {[{ v: 5, l: "Quiet" }, { v: 15, l: "Steady" }, { v: 30, l: "Busy" }, { v: 60, l: "High" }, { v: 100, l: "Enterprise" }].map(({ v, l }) => (
              <button key={v} onClick={() => setCallsPerDay(v)}
                className={`text-[10px] font-alte font-normal transition-colors ${callsPerDay === v ? "text-[#0A1128]" : "text-gray-300 hover:text-gray-500"}`}>
                {l}
              </button>
            ))}
          </div>
        ...
        <div>
          <p className="text-sm font-normal font-alte text-[#0A1128] mb-1">Avg call length</p>
          <p className="text-xs text-gray-400 mb-3 font-alte font-normal">Most business calls: 1-2 min</p>
        ...
        {([1, 2, 3] as TierKey[]).map((key) => {
          ...
          return (
            <div key={key}
              ...
              {/* Tier name + badge */}
              <div className="flex items-center justify-between">
                <p className={`text-xs font-geist font-normal tracking-[0.02em] uppercase ${
                  isSmart ? "text-white/40" : isBlocked ? "text-gray-300" : "text-gray-400"
                }`}>{r.name}</p>
                {isSmart && <span className="text-[9px] font-geist font-normal tracking-[0.02em] uppercase px-2.5 py-1 rounded-full bg-[#FCCA07] text-[#0A1128]">Best fit</span>}
                {!isSmart && !isBlocked && key === 2 && <span className="text-[9px] font-normal font-alte text-[#2D22FF] bg-blue-50 px-2 py-0.5 rounded-full">Most popular</span>}
                {isBlocked && <span className="text-[9px] font-normal font-alte text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full">Volume too high</span>}
              </div>

              {/* Plan fee + voice rate */}
              <div className={`flex items-center gap-3 pb-4 border-b ${isSmart ? "border-white/10" : "border-gray-100"}`}>
                <div>
                  <span className={`text-2xl font-normal font-alte ${isSmart ? "text-white" : "text-[#0A1128]"}`}>${r.monthly}</span>
                  <span className={`text-xs ml-0.5 ${isSmart ? "text-white/30" : "text-gray-400"}`}>/mo</span>
                </div>
                <div className={`text-[11px] font-normal font-alte px-2.5 py-1 rounded-none ${isSmart ? "bg-white/10 text-white/60" : "bg-gray-100 text-gray-500"}`}>
              ...
              {/* Capacity warning */}
              {isBlocked && (
                <div className="text-[11px] text-amber-600 bg-amber-50 rounded-none px-3 py-2.5 leading-snug font-alte font-normal">
                ...
                <>
                  ...
                  <div>
                    <div className="flex justify-between text-[10px] mb-1.5">
                      ...
                      <span className={`font-normal font-alte ${isOver ? "text-amber-400" : "text-emerald-400"}`}>
                    ...
                    <p className={`text-[10px] mt-1 font-alte font-normal ${isSmart ? "text-white/25" : "text-gray-400"}`}>
                      {isOver
                  ...
                  <div className={`rounded-none p-5 text-center ${isSmart ? "bg-white/5" : "bg-gray-50 border border-[#e7e6e4]"}`}>
                    <p className={`text-[12px] font-geist font-normal uppercase tracking-[0.02em] mb-3 ${isSmart ? "text-white/30" : "text-gray-400"}`}>
                      Extra voice charges
                    </p>
                    <p
                      className={`font-alte font-normal leading-none transition-colors ${isOver ? "text-amber-400" : "text-emerald-400"}`}
                      style={{ fontSize: "3.5rem" }}>
                      {isOver ? `$${r.overageCost}` : "$0"}
                    </p>
                    <p className={`text-[11px] mt-2 leading-snug font-alte font-normal ${isSmart ? "text-white/25" : "text-gray-400"}`}>
                      {isOver
                  ...
                  {/* Monthly total */}
                  <div className={`flex justify-between text-xs font-normal font-alte pt-1 ${isSmart ? "text-white/60" : "text-gray-500"}`}>
                    <span>Est. monthly total</span>
                    <span className={isSmart ? "text-white" : "text-[#0A1128]"}>${r.total.toLocaleString()}/mo</span>
                  </div>

                  {/* SMS unlimited */}
                  <div className={`flex items-center justify-between text-xs pt-1 border-t font-alte font-normal ${isSmart ? "border-white/10 text-white/40" : "border-gray-100 text-gray-400"}`}>
              ...
              {isSmart ? (
                <a href={CAL_LINK} target="_blank" rel="noopener noreferrer"
                  className="mt-auto w-full bg-[#FCCA07] text-[#0A1128] text-xs font-alte font-normal py-3 rounded-none text-center block hover:bg-[#f0bd00] transition-colors active:scale-[0.98] tracking-wide">
                  Start with {r.name} →
                </a>
              ) : (
                <a href={CAL_LINK} target="_blank" rel="noopener noreferrer"
                  className={`mt-auto w-full border text-xs font-alte font-normal py-3 rounded-none text-center block transition-all ${
                    isBlocked
      ...
      <div className="px-8 py-4 bg-gray-50 border-t border-gray-100">
        <p className="text-[11px] text-gray-400 leading-relaxed font-alte font-normal">
  ...
  return (
    <section id="pricing" className="py-20 sm:py-24 bg-[#F9F6F4]">
      <Container>
        ...
        <h2 className="text-3xl sm:text-4xl font-alte font-normal text-[#0A1128] leading-[1.2] tracking-[-0.04em] mb-3">
          One missed call costs more<br className="hidden sm:block" /> than your entire monthly plan.
        </h2>
        <p className="text-gray-500 mb-10 max-w-lg font-alte font-normal">
        ...
        <div className="flex flex-col sm:flex-row mb-12 rounded-none overflow-hidden border border-[#e7e6e4]">
          <div className="flex-1 bg-[#0A1128] px-6 py-5">
            <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-white/60 mb-1.5">What you pay a human receptionist</p>
            <p className="text-2xl font-normal font-alte text-white">$3,000 - $4,500<span className="text-sm font-normal text-white/60">/month</span></p>
            <p className="text-xs text-white/60 mt-1 font-alte font-normal">Salary only. Add training, sick days, and zero night/weekend coverage.</p>
          </div>
          <div className="flex items-center justify-center bg-[#FCCA07] px-5 py-3 sm:py-0">
            <span className="text-[#0A1128] font-normal font-alte text-base tracking-tight">VS</span>
          </div>
          <div className="flex-1 bg-white px-6 py-5">
            <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-600 mb-1.5">Your Loop AI agent</p>
            <p className="text-2xl font-normal font-alte text-[#0A1128]">Starts at $49<span className="text-sm font-normal text-gray-500">/month</span></p>
            <p className="text-xs text-gray-600 mt-1 font-alte font-normal">Answers every call. Follows up on text. Works 24/7. Never quits.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 md:items-stretch">
          {tiers.map((t, i) => (
            <div key={i} className={`relative flex flex-col ${t.badge ? "mt-5" : ""}`}>
              {t.badge && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#FCCA07] text-[#0A1128] text-xs font-alte font-normal px-4 py-1.5 rounded-full whitespace-nowrap z-10">{t.badge}</div>
              )}
              <div className={`rounded-none border flex flex-col flex-1 overflow-hidden ${t.highlight ? "bg-[#0A1128] border-[#0A1128] text-white" : "bg-white border-[#e7e6e4] text-[#0A1128]"}`}>
                <div className={`px-6 pt-7 pb-5 border-b ${t.highlight ? "border-white/10" : "border-gray-100"}`}>
                  <span className={`inline-flex px-2.5 py-1 rounded-full text-[12px] font-geist font-normal tracking-[0.02em] uppercase mb-3 ${t.highlight ? "bg-blue-500/20 text-blue-300" : "bg-blue-50 text-blue-600"}`}>{t.tag}</span>
                  <div className={`flex items-start gap-1.5 text-xs mb-4 min-h-[2.5rem] font-alte font-normal ${t.highlight ? "text-white/60" : "text-gray-500"}`}>
                  ...
                  <p className={`text-xs font-normal font-alte mb-0.5 ${t.highlight ? "text-white/50" : "text-gray-400"}`}>{t.setup}</p>
                  <div className="flex items-baseline gap-1.5 mb-1">
                    <span className="text-4xl font-normal font-alte tracking-tight">{t.monthly}</span>
                    <span className={`text-sm ${t.highlight ? "text-white/50" : "text-gray-400"}`}>/month</span>
                  </div>
                  <p className={`text-xs mb-4 font-normal font-alte ${t.highlight ? "text-[#FCCA07]/70" : "text-gray-400"}`}>{t.perDay}, less than your coffee per appointment</p>
                  <div className={`rounded-none px-4 py-3 ${t.highlight ? "bg-white/8" : "bg-gray-100"}`}>
                    <p className={`text-[12px] font-geist font-normal tracking-[0.02em] uppercase mb-1 ${t.highlight ? "text-white/50" : "text-gray-500"}`}>Total value inside</p>
                    <div className="flex items-center gap-2">
                      <span className={`text-lg font-normal font-alte line-through ${t.highlight ? "text-white/40" : "text-gray-400"}`}>{t.worthOf}</span>
                      <span className={`text-[10px] font-normal font-alte px-2 py-0.5 rounded-full ${t.highlight ? "bg-white/15 text-white/70" : "bg-gray-300 text-gray-600"}`}>you save</span>
                    </div>
                  </div>
                </div>
                <div className={`mx-5 mt-4 px-3.5 py-2.5 rounded-none flex items-start gap-2.5 ${t.highlight ? "bg-green-400/10 border border-green-400/20" : "bg-green-50 border border-green-100"}`}>
                  ...
                  <p className={`text-xs leading-snug font-alte font-normal ${t.highlight ? "text-green-300" : "text-green-700"}`}>{t.roi}</p>
                </div>
                <div className="px-6 py-5 space-y-5">
                  {t.featureGroups.map((group, gi) => (
                    <div key={gi}>
                      <p className={`text-[12px] font-geist font-normal tracking-[0.02em] uppercase mb-2 ${t.highlight ? "text-white/35" : "text-gray-400"}`}>{group.label}</p>
                      <ul className="space-y-1.5">
                        {group.items.map((f, j) => (
                          <li key={j} className={`flex items-start gap-2 text-sm leading-snug font-alte font-normal ${t.highlight ? "text-white/80" : "text-gray-600"}`}>
                            ...
                            <span>
                              {f.text}
                              {f.val && <span className={`ml-1.5 text-[10px] font-normal font-alte px-1.5 py-0.5 rounded-none ${t.highlight ? "bg-[#FCCA07]/20 text-[#FCCA07]" : "bg-blue-50 text-blue-500"}`}>{f.val}</span>}
                            </span>
                          </li>
                        ))}
                      </ul>
                ...
                <div className={`px-6 pb-6 pt-4 border-t ${t.highlight ? "border-white/10" : "border-gray-100"}`}>
                  {t.overage && <p className={`text-xs mb-2 font-alte font-normal ${t.highlight ? "text-white/30" : "text-gray-400"}`}>Overage: {t.overage}</p>}
                  <p className={`text-xs mb-4 font-alte font-normal ${t.highlight ? "text-white/40" : "text-gray-400"}`}>Best for: {t.best}</p>
                  <button onClick={() => window.open(t.ctaHref, "_blank", "noopener,noreferrer")}
                    className={`inline-flex items-center justify-center w-full py-3 rounded-none text-sm font-alte font-normal transition-all active:scale-[0.98] cursor-pointer whitespace-nowrap ${t.highlight ? "bg-[#FCCA07] text-[#0A1128] hover:bg-[#f0bd00]" : "bg-[#0A1128] text-white hover:bg-[#0d1633]"}`}>
                    Build My AI Agent
                  </button>
                </div>
              </div>
        ...
        {/* Trust strip */}
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 py-5 px-6 rounded-none border border-[#e7e6e4] bg-white text-sm text-gray-500 font-alte font-normal">
        ...
        <div className="mt-8 border border-[#e7e6e4] rounded-none overflow-hidden bg-white">
          <div className="px-6 py-5 border-b border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-normal font-alte text-[#0A1128]">Booster Pack Recharge</p>
            </div>
            <p className="text-xs text-gray-500 leading-relaxed max-w-xl font-alte font-normal">
              When your included minutes are used up, top up with a Booster Pack. Set it to{" "}
              <strong className="text-gray-700 font-normal">trigger automatically</strong> when your balance drops below a threshold, or do it{" "}
              <strong className="text-gray-700 font-normal">manually</strong> from the dashboard. No surprise charges either way.
            </p>
          </div>
          <div className="px-6 py-4">
            <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-gray-400 mb-3">⏱ Minutes Booster</p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-gray-50">
                    {["For Plan", "Pack", "Price", "Minutes Added", "Effective Rate"].map((h) => (
                      <th key={h} className="text-left text-[12px] font-geist font-normal text-gray-500 uppercase tracking-[0.02em] px-4 py-2.5 border border-[#e7e6e4] whitespace-nowrap">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={i} className="hover:bg-gray-50/60 transition-colors font-alte font-normal">
                      <td className="px-4 py-3 border border-[#e7e6e4] font-normal text-[#0A1128] text-xs whitespace-nowrap">{row.plan}</td>
                      <td className="px-4 py-3 border border-[#e7e6e4] text-gray-600 text-xs">{row.pack}</td>
                      <td className="px-4 py-3 border border-[#e7e6e4] font-normal text-[#0A1128] text-sm">{row.price}</td>
                      <td className="px-4 py-3 border border-[#e7e6e4] text-gray-600 text-xs">{row.minutes}</td>
                      <td className="px-4 py-3 border border-[#e7e6e4] text-gray-600 text-xs font-normal">{row.rate}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            </div>
            <p className="text-[11px] text-gray-400 mt-2.5 font-alte font-normal">Unused minutes roll over to the next month. Packs can be stacked.</p>
          </div>
          <div className="px-6 py-3 bg-gray-50 border-t border-gray-100">
            <p className="text-[11px] text-gray-400 text-center font-alte font-normal">All Booster Packs are pre-purchased blocks, not per-minute billing. You always know exactly what you&apos;re spending.</p>
          </div>
        </div>

        <p className="text-xs text-gray-400 mt-4 text-center font-alte font-normal">
  ...
  return (
    <section className="py-20 sm:py-24 bg-[#F9F6F4]">
      <Container>
        ...
        <h2 className="text-3xl sm:text-4xl font-alte font-normal text-[#0A1128] leading-[1.2] tracking-[-0.04em] mb-2 max-w-2xl">
          Find out how many leads you&apos;re losing right now.<br />
          <span className="text-gray-400">Before you spend anything.</span>
        </h2>
        <p className="text-gray-500 mb-10 max-w-xl font-alte font-normal">
          ...
          <strong className="text-[#0A1128] font-normal">48 hours. Free. No commitment.</strong>
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {audits.map((a, i) => (
            <div key={i} className="bg-white border border-[#e7e6e4] rounded-none p-6 flex flex-col">
              <div className="text-3xl mb-3">{a.icon}</div>
              <p className="text-[12px] font-geist font-normal text-blue-600 tracking-[0.02em] uppercase mb-1">{a.for}</p>
              <p className="font-alte font-normal text-[#0A1128] text-xl mb-2">{a.name}</p>
              <p className="text-sm text-gray-500 leading-relaxed flex-1 mb-4 font-alte font-normal">{a.desc}</p>
              <OutlineBtn href={CAL_LINK} label="Request this audit" size="sm" />
            </div>
          ))}
        </div>
        <p className="text-sm text-gray-400 text-center font-alte font-normal">
          Not a clinic, agency, or recruiter?{" "}
          <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-normal">Request a general missed-call audit.</a>
        </p>
      </Container>
    </section>
  );
        ...
        <div className="space-y-2">
          {faqs.map((faq, i) => (
            <div key={i} className="bg-white rounded-none border border-[#e7e6e4] overflow-hidden">
              ...
              >
                <span className="font-normal font-alte text-sm text-[#0A1128]">{faq.q}</span>
              ...
              {open === i && (
                <div className="px-6 pb-5">
                  <p className="text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-4 font-alte font-normal">{faq.a}</p>
                </div>
              )}
            </div>
          ))}
  ...
  return (
    <section className="py-20 sm:py-28 bg-[#0A1128]">
      <Container className="text-center" size="md">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-alte font-normal text-white leading-[1.2] tracking-[-0.04em] mb-4">
          Your competitor picked up that call.<br />
          <span className="text-white/60">You can answer the next one.</span>
        </h2>
        <p className="text-white/50 mb-10 max-w-md mx-auto text-sm leading-relaxed font-alte font-normal">
        ...
        {STATS.demoNumber && (
          <p className="mt-4 text-white/30 text-xs font-alte font-normal">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {audits.map((a) => (
              <a key={a.label} href={CAL_LINK} target="_blank" rel="noopener noreferrer"
                ...
                <p className="text-sm font-normal font-alte text-white/80 group-hover:text-white transition-colors">{a.label}</p>
                <p className="text-[11px] text-white/35 font-alte font-normal">{a.desc}</p>
              </a>
            ))}
          </div>
        </div>
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
            {["$0 to start", "Live in 30 mins", "No tech setup", "Cancel anytime"].map((t, i) => (
              <span key={i} className="flex items-center gap-1.5 text-xs text-white/40 font-alte font-normal">
    ...
    <Container size="lg">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-10 border-b border-white/[0.08]">
        <div className="lg:col-span-2">
          <Link href="/" className="font-alte text-lg text-white font-normal tracking-[-0.04em] mb-2 block">Loop</Link>
          <p className="text-xs text-white/40 mb-1 font-alte font-normal">Voice + Text AI</p>
          <p className="text-sm text-white/55 leading-relaxed mt-3 max-w-xs font-alte font-normal">
            Vox answers the call. Relay follows up on text. Your business never misses a lead again.
          </p>
          <div className="flex items-center gap-4 mt-5">
            <a href="mailto:aditya@tryagentikai.com" className="flex items-center gap-1.5 text-xs text-white/35 hover:text-white/60 transition-colors font-alte font-normal">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              aditya@tryagentikai.com
            </a>
            <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-white/35 hover:text-[#FCCA07] transition-colors font-alte font-normal">
        ...
        <div>
          <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-white/30 mb-4">Product</p>
          <nav className="flex flex-col gap-2.5">
            <button onClick={() => smoothScrollTo("use-cases")} className="text-sm text-white/50 hover:text-white text-left transition-colors font-alte font-normal">Use Cases</button>
            <button onClick={() => smoothScrollTo("pricing")} className="text-sm text-white/50 hover:text-white text-left transition-colors font-alte font-normal">Pricing</button>
            <button onClick={() => smoothScrollTo("faq")} className="text-sm text-white/50 hover:text-white text-left transition-colors font-alte font-normal">FAQ</button>
            <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white transition-colors font-alte font-normal">Book a Call</a>
          </nav>
        </div>
        <div>
          <p className="text-[12px] font-geist font-normal tracking-[0.02em] uppercase text-white/30 mb-4">Free Audits</p>
          <nav className="flex flex-col gap-2.5">
            <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white transition-colors font-alte font-normal">Ghost Patient Report</a>
            <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white transition-colors font-alte font-normal">Speed-to-Lead Test</a>
            <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white transition-colors font-alte font-normal">Hiring Volume Audit</a>
          </nav>
        </div>
      </div>
      <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <p className="text-xs text-white/25 font-alte font-normal">© 2026 Agentic AI Labs. Built for global businesses.</p>
        <div className="flex gap-5 text-xs text-white/25 font-alte font-normal">
...
const StickyMobileCTA = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-[#e7e6e4] px-4 py-3">
      <BracketButton label="Take Your AI Live in 30 Mins" href={CAL_LINK} variant="primary" external className="w-full" />
    </div>
  );
};
