...
import B2bSaasLeadsGraphic from "src/components/sections/SgServices/B2bSaasLeadsGraphic";
import { B2B_SAAS_LEADS_COPY } from "src/components/sections/SgServices/b2bSaasLeads.copy";

const copy = B2B_SAAS_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={B2bSaasLeadsGraphic} />
  </>
);
