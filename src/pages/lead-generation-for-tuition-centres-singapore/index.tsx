...
import TuitionLeadsGraphic from "src/components/sections/SgServices/TuitionLeadsGraphic";
import { TUITION_LEADS_COPY } from "src/components/sections/SgServices/tuitionLeads.copy";

const copy = TUITION_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={TuitionLeadsGraphic} />
  </>
);
