...
import AppointmentSettingGraphic from "src/components/sections/SgServices/AppointmentSettingGraphic";
import { APPOINTMENT_SETTING_COPY } from "src/components/sections/SgServices/appointmentSetting.copy";

const copy = APPOINTMENT_SETTING_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={AppointmentSettingGraphic} />
  </>
);
