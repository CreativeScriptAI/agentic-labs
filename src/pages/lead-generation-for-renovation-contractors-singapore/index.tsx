...
import RenovationLeadsGraphic from "src/components/sections/SgServices/RenovationLeadsGraphic";
import { RENOVATION_LEADS_COPY } from "src/components/sections/SgServices/renovationLeads.copy";

const copy = RENOVATION_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={RenovationLeadsGraphic} />
  </>
);
