...
const SectionLabel = ({ text }: { text: string }) => (
    <p className="text-xs font-normal text-blue-600 tracking-[0.02em] uppercase mb-4 font-geist">
        {text}
    </p>
);
...
const AiReceptionistMedicalPage: NextPageWithLayout = () => {
    ...
    return (
        <>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                    <nav aria-label="Breadcrumb">
                        <ol className="flex items-center gap-2 text-xs text-gray-500 font-alte">
                            ...
                            <li><span className="text-gray-300">/</span></li>
                            <li className="text-gray-800 font-normal">AI Receptionist for Medical Clinics</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="space-y-7">
                            ...
                            <motion.div
                                ...
                                className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 text-xs font-normal tracking-[0.02em] uppercase py-1.5 px-3 rounded-none font-geist"
                            >
                        ...
                        >
                            ...
                            <div className="bg-white rounded-none border border-[#e7e6e4] overflow-hidden">
                                <div className="bg-red-50 border-b border-red-100 px-6 py-4">
                                    <p className="text-xs font-normal text-red-600 uppercase tracking-[0.02em] font-geist">
                                ...
                                <div className="px-6 py-5 space-y-3">
                                    ...
                                    <div className="pt-3 mt-1 border-t border-[#e7e6e4] flex items-center justify-between">
                                        ...
                                        <span className="text-base font-normal text-red-600 font-alte">$73,500+ / yr</span>
                                    </div>
                                </div>
            ...
            <Section id="problem" bg="white">
                ...
                >
                    ...
                    <footer className="mt-4 text-xs text-gray-500 font-alte flex items-center gap-2">
                        <span className="inline-block bg-orange-100 text-orange-700 px-2 py-0.5 rounded-none font-normal text-[10px] uppercase tracking-[0.02em] font-geist">
                            r/medicine
                        </span>
                        ...
                        >
                            <div className={`${colorMap[layer.color].bg} px-7 py-6 border-b ${colorMap[layer.color].border}`}>
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className={`text-xs font-normal ${colorMap[layer.color].text} tracking-[0.02em] uppercase font-geist`}>
                                        Layer {layer.num}
                                    </span>
                                </div>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="text-xs font-normal text-gray-400 uppercase tracking-[0.02em] font-geist">{step.week}</span>
            ...
            <Section id="results" bg="warm">
                ...
                >
                    ...
                    <div className="px-6 pt-6 pb-4 flex flex-col sm:flex-row items-start sm:items-center gap-5">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1.5">
                                <span className="bg-red-500 text-white text-[10px] font-normal px-2 py-0.5 rounded-none font-geist uppercase tracking-[0.02em]">
                                    NEW
                                </span>
                    ...
                    <div className="px-6 py-4 bg-[#F9F6F4]">
                        <p className="text-xs font-normal text-gray-500 uppercase tracking-[0.02em] font-geist mb-3">
            ...
            <Section id="is-this-for-you" bg="white">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-10">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-none p-6">
                        <p className="text-xs font-normal text-green-700 uppercase tracking-[0.02em] font-geist mb-4">
                            This is for you if:
                        </p>
                    ...
                    <div className="bg-gray-50 border border-[#e7e6e4] rounded-none p-6">
                        <p className="text-xs font-normal text-gray-500 uppercase tracking-[0.02em] font-geist mb-4">
            ...
            {/* ── Related Pages ── */}
            <Section bg="white">
                <p className="text-xs font-normal text-gray-400 uppercase tracking-[0.02em] font-geist mb-5">
            ...
            {showSticky && (
                ...
                >
                    <div className="bg-[#0A1128] rounded-none border border-white/10 px-5 py-3.5 flex items-center justify-between gap-4">
                        ...
                        <Link
                            href={CAL_LINK}
                            className="flex-shrink-0 bg-[#FCCA07] text-[#0A1128] text-sm font-normal px-4 py-2 rounded-none hover:bg-yellow-400 transition-colors cursor-pointer font-alte"
                        >
                            Book a Call
                        </Link>
                    </div>
