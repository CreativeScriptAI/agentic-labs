...
import AiAutomationGraphic from "src/components/sections/SgServices/AiAutomationGraphic";
import { AI_AUTOMATION_COPY } from "src/components/sections/SgServices/aiAutomation.copy";

const copy = AI_AUTOMATION_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={AiAutomationGraphic} />
  </>
);
