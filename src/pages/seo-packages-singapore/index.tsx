...
import SeoPackagesGraphic from "src/components/sections/SgServices/SeoPackagesGraphic";
import { SEO_PACKAGES_COPY } from "src/components/sections/SgServices/seoPackages.copy";

const copy = SEO_PACKAGES_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={SeoPackagesGraphic} />
  </>
);
