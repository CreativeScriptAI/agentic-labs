...
import LandingPagesGraphic from "src/components/sections/SgServices/LandingPagesGraphic";
import { LANDING_PAGES_COPY } from "src/components/sections/SgServices/landingPages.copy";

const copy = LANDING_PAGES_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={LandingPagesGraphic} />
  </>
);
