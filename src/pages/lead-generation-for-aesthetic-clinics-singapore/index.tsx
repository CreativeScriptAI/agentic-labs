...
import AestheticClinicLeadsGraphic from "src/components/sections/SgServices/AestheticClinicLeadsGraphic";
import { AESTHETIC_CLINIC_LEADS_COPY } from "src/components/sections/SgServices/aestheticClinicLeads.copy";

const copy = AESTHETIC_CLINIC_LEADS_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={AestheticClinicLeadsGraphic} />
  </>
);
