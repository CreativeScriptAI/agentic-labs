...
import LocalSeoGraphic from "src/components/sections/SgServices/LocalSeoGraphic";
import { LOCAL_SEO_COPY } from "src/components/sections/SgServices/localSeo.copy";

const copy = LOCAL_SEO_COPY;
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={LocalSeoGraphic} />
  </>
);
