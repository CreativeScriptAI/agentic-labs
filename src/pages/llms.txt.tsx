...
const buildLlmsTxt = (): string => {
  ...
  lines.push(`- [what-is-geo](${BASE}/glossary/what-is-geo/): what generative engine optimization (GEO) is`);
  lines.push(`- [what-is-rag](${BASE}/glossary/what-is-rag/): what retrieval augmented generation (RAG) is`);
  lines.push(`- [what-is-lead-scoring](${BASE}/glossary/what-is-lead-scoring/): what lead scoring is`);
  lines.push(`- [what-is-conversational-ai](${BASE}/glossary/what-is-conversational-ai/): what conversational AI is`);
  lines.push(`- [what-is-whatsapp-business-api](${BASE}/glossary/what-is-whatsapp-business-api/): what the WhatsApp Business API is`);
  lines.push(`- [what-is-the-do-not-call-registry](${BASE}/glossary/what-is-the-do-not-call-registry/): what Singapore's Do Not Call registry is`);
  lines.push(`- [what-is-click-through-rate](${BASE}/glossary/what-is-click-through-rate/): what click through rate (CTR) is`);
  lines.push(`- [what-is-cost-per-lead](${BASE}/glossary/what-is-cost-per-lead/): what cost per lead (CPL) is`);
  lines.push(`- [what-is-customer-acquisition-cost](${BASE}/glossary/what-is-customer-acquisition-cost/): what customer acquisition cost (CAC) is`);
  lines.push(`- [what-is-marketing-automation](${BASE}/glossary/what-is-marketing-automation/): what marketing automation is`);
  lines.push(`- [what-is-a-drip-campaign](${BASE}/glossary/what-is-a-drip-campaign/): what a drip campaign is`);
  lines.push(`- [what-is-no-show-rate](${BASE}/glossary/what-is-no-show-rate/): what no-show rate is and how to lower it`);
  lines.push(`- [what-is-appointment-setting](${BASE}/glossary/what-is-appointment-setting/): what appointment setting is`);
  lines.push(`- [what-is-a-sales-development-representative](${BASE}/glossary/what-is-a-sales-development-representative/): what a sales development representative (SDR) is`);
  lines.push(`- [what-is-return-on-ad-spend](${BASE}/glossary/what-is-return-on-ad-spend/): what return on ad spend (ROAS) is`);
  lines.push("");
