...
import SocialGraphic from "src/components/sections/SgServices/SocialGraphic";
import { SOCIAL_COPY } from "src/components/sections/SgServices/social.copy";
...
const Page = () => (
  <>
    ...
    <ServicePage copy={copy} Graphic={SocialGraphic} />
  </>
);
