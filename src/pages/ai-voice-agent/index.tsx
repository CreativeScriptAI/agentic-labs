...
const PricingCalculator = () => {
  ...
  const TIERS = {
    1: { name: "Starter",      voiceRate: 6,    monthly: 2499,  included: 100,  concurrent: 1,  maxCallsPerDay: 15  },
    2: { name: "Professional", voiceRate: 5,    monthly: 9999,  included: 1500, concurrent: 3,  maxCallsPerDay: 40  },
    3: { name: "Enterprise",   voiceRate: 4.5,  monthly: 24999, included: 5000, concurrent: 10, maxCallsPerDay: 999 },
  } as const;
          ...
          <div className="px-6 py-4 border-b border-gray-100">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  {[
                    { plan: "🌱 Starter",       price: "₹600",   minutes: "100 minutes",   rate: "₹6/min" },
                    { plan: "📈 Professional",  price: "₹2,500", minutes: "500 minutes",   rate: "₹5/min" },
