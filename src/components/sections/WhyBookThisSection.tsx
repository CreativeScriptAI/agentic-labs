...
const WhyBookThisSection = () => {
  ...
  return (
    <section className="section">
      <h2 className="section_title text-[#0A1128] font-alte font-normal leading-[1.2] tracking-[-0.04em]">Why Book This</h2>
          ...
          <ul className="flex flex-col items-start gap-3 md:gap-8 mb-8">
            {reasons.map((reason, index) => (
              <li key={index} className="flex items-start gap-4">
                ...
                <p
                  className="text-[#0A1128] font-alte text-[15px] font-normal leading-[1.5] tracking-[-0.04em] m-0 flex-1 [&_strong]:font-normal"
