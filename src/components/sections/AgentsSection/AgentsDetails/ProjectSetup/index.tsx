...
const ProjectSetup = ({ data }: ProjectSetupProps) => {
  return (
    <section className="section">
      <div className="flex flex-col items-center justify-center text-center mb-6 md:mb-8 gap-2 md:gap-3">
      ...
      <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
