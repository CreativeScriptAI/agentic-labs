...
export const GOOGLE_ADS_COPY: ServiceCopy = {
  ...
  deepDive: {
    eyebrow: "SEM IN SINGAPORE, IN PLAIN TERMS",
    heading: "What Google Ads in Singapore actually costs, and how fast it pays back",
    sections: [
      {
        h2: "how much does it cost to run google ads in singapore per month?",
        body: [
      ...
      {
        h2: "flat fee or percentage of ad spend, which google ads management model is better?",
        body: [
      ...
      {
        h2: "how long does it take for google ads to start working in singapore?",
        body: [
      ...
      {
        h2: "search ads, performance max, or meta ads, which should i use?",
        body: [
