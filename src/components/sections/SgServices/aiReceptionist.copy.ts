    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          [
            { text: "This is why the fastest credible response matters. Research on online sales leads, including the widely cited Lead Response Management study associated with James Oldroyd and the related Harvard Business Review work on " },
            { text: "the short life of online leads", href: "https://hbr.org/2011/03/the-short-life-of-online-sales-leads" },
            { text: ", found that answering within about five minutes made a lead far likelier to qualify than waiting longer. That is US B2B online-lead data, directional support for answering fast rather than a Singapore phone benchmark, but the direction holds. A call answered now is worth more than the same call returned tomorrow." },
          ],
        ],
      },
    ],
