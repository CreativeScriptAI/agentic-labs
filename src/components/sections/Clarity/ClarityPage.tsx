...
/* ─── Lazy video — only load src when in viewport ───────────── */
function LazyVideo({ src, style, ...props }: React.ComponentProps<"video">) {
...
const IdeaIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" style={{ width: 22, height: 22 }}>
    <path
      d="M9 21h6M12 3a6 6 0 00-3.5 10.9V17a1 1 0 001 1h5a1 1 0 001-1v-3.1A6 6 0 0012 3z"
      stroke="#FCCA07"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
      ...
      >
        ...
        {isBooked ? (
          ...
          >
            ...
            >
              {firstName ? `${firstName}'s call confirmed` : "Call confirmed"}
            </span>
          </span>
        ) : (
          <a
            ...
            onMouseOver={(e) => {
              e.currentTarget.style.backgroundColor = "#f0bc00";
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.backgroundColor = "#FCCA07";
            }}
          >
            Book Free Call
          </a>
      ...
      >
            ...
            <>
              ...
              >
                {email ? (
                  ...
                  <>
                    We&apos;ve sent a calendar invite to your inbox with the
                    Google Meet link.
                  </>
                )}
                {formattedDate
              ...
              >
                <div
                  style={{
                    padding: "clamp(16px, 4vw, 20px) clamp(20px, 4vw, 24px)",
                  }}
                >
                  <div
                    style={{
        ...
        <section style={{ padding: "0 0 48px" }}>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Hi, I&apos;m Aditya, the founder of Agentic AI Labs. I&apos;ll
                be the one you&apos;ll speak with on our Clarity Call.
              </p>
              <p
                style={{
                  fontSize: "15px",
        ...
        >
          <div style={{ maxWidth: "1024px", margin: "0 auto" }}>
            ...
            {/* Feature list — mobile: stacked, desktop: 2-col cards */}
            <div
              style={{
                display: "grid",
                gridTemplateColumns:
                ...
                >
                  ...
                  >
                    {s.fixed ? (
                      ...
                      <Counter to={s.num as number} suffix={s.suffix} />
                    )}
                  </div>
                  <div
                    style={{
            ...
            >
              {[
                ...
                },
                {
                  ...
                  text: "Voice agent: calls new leads instantly, follows up Day 1–5, qualifies, handles objections, books into GoHighLevel, sends a Stripe deposit by SMS.",
                },
                {
                  label: "The result:",
        ...
        <section style={{ padding: "48px 0" }}>
          <div style={{ textAlign: "center", marginBottom: "32px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#475569" }}>
              We are engineers, builders, and operators.
            </p>
          </div>
          ...
          <div style={{ maxWidth: "1024px", margin: "0 auto" }}>
            ...
            >
              {[
                {
                  quote:
                    "Aditya definitely knows his stuff when it comes to AI and development. He brought strong technical expertise to the table and helped guide us through some complex systems with clarity and precision. It was a smooth and productive experience working with him, and I appreciated his thoughtful input throughout the project. Would absolutely recommend him to anyone needing high-level AI or dev support!",
                  name: "Founder",
                  role: "AI Integration Client",
                },
                {
                  quote:
                    "Aditya helped me save tremendous amout of time with his expertise. I highly recommend him.",
                  name: "Founder",
                  role: "Operations Client",
                },
                {
                  quote:
                    "These guys are super helpful and communicative! Definitely consider them on your next AI build or MVP.",
                  name: "Founder",
                  role: "Startup Client",
                },
              ].map((t, i) => (
          ...
          >
            {!isBooked ? (
              <>
                ...
                >
                  Free. 30 minutes. No pitch. No pressure. A straight answer on
                ...
                >
                  Worst case: 30 minutes. Best case: an opportunity worth
                  thousands per month.
                </p>
              </>
            ) : (
              <>
                ...
                >
                  {firstName ? `${firstName}, here's` : "Here's"} how to
                  prepare.
                </h2>
                <p
                  style={{
                ...
                >
                  3 things to think about before we meet.
                </p>
