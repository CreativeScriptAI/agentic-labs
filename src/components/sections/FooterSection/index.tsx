    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <Link href="https://cal.com/ai-aditya/30min" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 text-sm sm:text-base transition-colors">Book a Call</Link>
          <Link href="/privacy-policy/" className="text-gray-500 hover:text-gray-700 text-sm sm:text-base transition-colors">Privacy Policy</Link>
        </div>
